!function (t) {
  ...
  return function t(e, n, i) {
    ...
    1: [function (t, e, n) {
      ...
      var r = Object.prototype.toString, s = Object.prototype.hasOwnProperty;
      e.exports = function (t) {
        if (!t) return console.warn("bindAll requires at least one argument.");
        var e = Array.prototype.slice.call(arguments, 1);
        if (0 === e.length) for (var n in t) s.call(t, n) && "function" == typeof t[n] && "[object Function]" == r.call(t[n]) && e.push(n);
    ...
    2: [function (t, e, n) {
      ...
      e.exports = i, i.EventEmitter = i, i.prototype._events = void 0, i.prototype._maxListeners = void 0, i.defaultMaxListeners = 10, i.prototype.setMaxListeners = function (t) {
        ...
        } else if (o(n)) for (s = Array.prototype.slice.call(arguments, 1), u = n.slice(), i = u.length, l = 0; i > l; l++) u[l].apply(this, s);
        return !0
    ...
    6: [function (t, e, n) {
      ...
      var o = "undefined" != typeof document ? document.createElement("p").style : {}, a = ["O", "ms", "Moz", "Webkit"],
        l = /([A-Z])/g, u = {};
    ...
    8: [function (t, e, n) {
      (function (n) {
        ...
        if (!a || !l) {
          var h = 0, c = 0, f = [], p = 1e3 / 60;
          a = function (t) {
            if (0 === f.length) {
              var e = i(), n = Math.max(0, p - (e - h));
    ...
    9: [function (t, e, n) {
      ...
      i.prototype = {
        on: function (t, e, n) {
          ...
          if (i && e) for (var s = 0, o = i.length; o > s; s++) i[s].fn !== e && i[s].fn._ !== e && r.push(i[s]);
    ...
    11: [function (t, e, n) {
      ...
      var r = t("object-assign"), s = t("tiny-emitter"), o = t("lethargy").Lethargy, a = t("./support"),
        l = (t("./clone"), t("bindall-standalone")), u = "virtualscroll";
      e.exports = i;
    ...
    13: [function (t, e, n) {
      ...
      var l = function () {
        ...
        }(), u = t("events"), h = t("virtual-scroll"), c = i(h), f = t("raf"), p = i(f), v = t("prefix"), d = i(v),
        y = function (t) {
          function e(t) {
            r(this, e);
            ...
            return n._bind(), n.options = Object.assign({
              ...
              speed: 0,
              speedTarget: 0
            }, n.wrapper = document.createElement("div"), n.wrapper.setAttribute("class", "horizontal-scroll"), n.vs = new c["default"], n.transform = d["default"]("transform"), n.raf = p["default"], n._setUI(), n._addEvents(), n.onResize(), n
          }
          ...
          return o(e, t), l(e, [{
            ...
            key: "_update", value: function () {
              ...
              var t = this.vars.scrollTarget - this.vars.scrollValue, e = t / this.options.skewReducer;
            ...
            key: "_clamp", value: function (t, e, n) {
